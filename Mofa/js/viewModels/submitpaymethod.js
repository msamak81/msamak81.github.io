    ...
    function(oj, ko, $, ArrayDataProvider) {
        ...
        function DashboardViewModel() {
            ...
            self.connected = function() {
                ...
                self.tableHeader = [
                    {"headerText": "Effective Date","field": "name","headerClassName": "","className": "","resizable": "disabled"},
                    {"headerText": "Bank Name","field": "name","headerClassName": "","className": "","resizable": "disabled"},
                    {"headerText": "Account Number","field": "name","headerClassName": "","className": "","resizable": "disabled"},
                ...
                self.addsubmitpaymethod = function(event){
                   oj.Router.rootInstance.go('submitpaymethodadd');
                }

                self.updatesubmitpaymethod = function(event){
                    oj.Router.rootInstance.go('submitpaymethodupdate');
                 }
