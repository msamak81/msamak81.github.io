    ...
    function AboutViewModel() {
      ...
      self.connected = function() {
        // Implement if needed
          ...
          self.previewArray = [
              { RelativeID: 101 , description: 'National ID', proposed: 'Mission', current: 'Spouse'},
              { RelativeID: 102, description: 'National ID Copy', proposed: 'Irkab Decision', current: 'child'},
              { RelativeID: 103,description: 'Issue Start Date', proposed: 'visiting New York council', current: 'child'},
              { RelativeID: 104,description: 'Issue End Date', proposed: '2323223', current: 'child'},
              { RelativeID: 105, description: 'Issue Authority', proposed: 'New York', current: 'child'},
              { RelativeID: 105, description: 'Place of Birth', proposed: 'Vacation', current: 'child'},
              { RelativeID: 105, description: 'Hafiza Place', proposed: 'Vacation', current: 'child'},
