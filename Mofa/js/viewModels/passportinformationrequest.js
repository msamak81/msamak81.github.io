    ...
    function AboutViewModel() {
      ...
      self.connected = function() {
        // Implement if needed
          ...
          self.previewArray = [
              { RelativeID: 101 , description: 'Request Type', proposed: 'Mission', current: 'Spouse'},
              { RelativeID: 102, description: 'Decree Details', proposed: 'Irkab Decision', current: 'child'},
              { RelativeID: 103,description: 'Destination', proposed: 'visiting New York council', current: 'child'},
              { RelativeID: 104,description: 'Start Date', proposed: '2323223', current: 'child'},
              { RelativeID: 105, description: 'End Date', proposed: 'New York', current: 'child'},
              { RelativeID: 105, description: 'Type of Issue', proposed: 'Vacation', current: 'child'},
              { RelativeID: 105, description: 'Old Passport Number', proposed: '18/12/2018', current: 'child'},
              { RelativeID: 105, description: 'Requesting For', proposed: '19/12/2020', current: 'child'},
              { RelativeID: 105, description: 'Employee or Dependent', proposed: 'Business Class', current: 'child'},
              { RelativeID: 105, description: 'Title(Arabic)', proposed: 'Business Class', current: 'child'},
              { RelativeID: 105, description: 'Title (English)', proposed: 'Business Class', current: 'child'},
              { RelativeID: 105, description: 'Dependent/Self name in English', proposed: 'Business Class', current: 'child'},
              { RelativeID: 105, description: 'Relation Ship', proposed: 'Business Class', current: 'child'},
              { RelativeID: 105, description: 'Age', proposed: 'Business Class', current: 'child'},
              { RelativeID: 105, description: 'Place of Birth', proposed: 'Business Class', current: 'child'},
              { RelativeID: 105, description: 'DOB in HIjri', proposed: 'Business Class', current: 'child'},
              { RelativeID: 105, description: 'DOB in Gregorian', proposed: 'Business Class', current: 'child'},
              { RelativeID: 105, description: 'National ID', proposed: 'Business Class', current: 'child'},
              { RelativeID: 105, description: 'Naitonal ID Copy', proposed: 'Business Class', current: 'child'},
              { RelativeID: 105, description: 'Mobile Number', proposed: 'Business Class', current: 'child'},
              { RelativeID: 105, description: 'Email', proposed: 'Business Class', current: 'child'},
              { RelativeID: 105, description: 'Place of Delivery', proposed: 'Business Class', current: 'child'},
              { RelativeID: 105, description: 'Remarks', proposed: 'Business Class', current: 'child'},
          ];
