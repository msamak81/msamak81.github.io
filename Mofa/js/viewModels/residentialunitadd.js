    ...
    function AboutViewModel() {
      ...
      self.connected = function() {
        // Implement if needed
          ...
          self.previewArray = [
              { RelativeID: 101 , description: 'Request No', proposed: '43434344', current: 'Spouse'},
              { RelativeID: 102, description: 'Request Type', proposed: 'normal', current: 'child'},
              { RelativeID: 103,description: 'Marital status', proposed: 'Married', current: 'child'},
              { RelativeID: 104,description: 'No of Dependents', proposed: '12', current: 'child'},
              { RelativeID: 105,description: 'Quarter Type - option 1', proposed: '1', current: 'child'},
              { RelativeID: 106,description: 'Quarter Type - option 2', proposed: '2', current: 'child'},
              { RelativeID: 107,description: 'Quarter Type - option 3', proposed: '3', current: 'child'},
              { RelativeID: 108,description: 'Date of Submission', proposed: 'Approved', current: 'child'},
              { RelativeID: 109,description: 'Reason of Appling the Request', proposed: 'Approved', current: 'child'},
              { RelativeID: 110,description: 'Special Case', proposed: 'yes', current: 'child'},
              { RelativeID: 111,description: 'Special Case Reason', proposed: 'sample Data', current: 'child'},
              { RelativeID: 112,description: 'Accept Another Type', proposed: 'yes', current: 'child'},
