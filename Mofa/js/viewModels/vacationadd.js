    ...
    function AboutViewModel() {
      ...
      self.connected = function() {
        // Implement if needed
          ...
          self.previewArray = [
              { RelativeID: 101 , description: 'Absence Status', proposed: 'Mission', current: 'Spouse'},
              { RelativeID: 102, description: 'Absence Type', proposed: 'Irkab Decision', current: 'child'},
              { RelativeID: 103,description: 'Absence Category', proposed: 'visiting New York council', current: 'child'},
              ...
              { RelativeID: 105, description: 'Days', proposed: 'Vacation', current: 'child'},
              { RelativeID: 105, description: 'Annual Leave Type', proposed: '18/12/2018', current: 'child'},
              { RelativeID: 105, description: 'Replaced By', proposed: '19/12/2020', current: 'child'},
