 ...
 */
define(['ojs/ojcore', 'knockout', 'jquery', 'ojs/ojarraydataprovider','ojs/ojknockout', 'ojs/ojrowexpander', 'promise', 'ojs/ojchart', 'ojs/ojflattenedtreetabledatasource', 'ojs/ojjsontreedatasource', 'ojs/ojarraytabledatasource', 'ojs/ojcheckboxset'],
    ...
    function AboutViewModel() {
      ...
      self.connected = function() {
        // Implement if needed
          ...
          self.previewArray = [
              { RelativeID: 101 , description: 'Year', proposed: 'Mission', current: 'Spouse'},
              { RelativeID: 102, description: 'Semester', proposed: 'Irkab Decision', current: 'child'},
              { RelativeID: 103,description: ' Relation Name', proposed: 'visiting New York council', current: 'child'},
              { RelativeID: 104,description: 'Age', proposed: '2323223', current: 'child'},
              { RelativeID: 105, description: 'Educational Stage', proposed: 'New York', current: 'child'},
              { RelativeID: 105, description: 'School Name', proposed: 'Vacation', current: 'child'},
              { RelativeID: 105, description: 'School Type', proposed: '18/12/2018', current: 'child'},
              { RelativeID: 105, description: 'Transfer Start Date', proposed: '19/12/2020', current: 'child'},
              { RelativeID: 105, description: 'Transfer Organization', proposed: 'Business Class', current: 'child'},
              { RelativeID: 105, description: 'Amount', proposed: 'Business Class', current: 'child'},
              { RelativeID: 105, description: 'Currency', proposed: 'Business Class', current: 'child'},
              { RelativeID: 105, description: 'Amount in SAR', proposed: 'Business Class', current: 'child'},
              { RelativeID: 105, description: 'Amount in USD', proposed: 'Business Class', current: 'child'},
              { RelativeID: 105, description: 'Declaration', proposed: 'Business Class', current: 'child'},
          ];
