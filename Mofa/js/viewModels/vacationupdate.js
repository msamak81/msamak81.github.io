    ...
    function AboutViewModel() {
      ...
      self.connected = function() {
        // Implement if needed
          ...
          self.previewArray = [
              { RelativeID: 101 , description: 'Action Type', proposed: 'Mission', current: 'Spouse'},
              { RelativeID: 102, description: 'Leave Record', proposed: 'Irkab Decision', current: 'child'},
              { RelativeID: 103,description: 'Old Start Date', proposed: 'visiting New York council', current: 'child'},
              { RelativeID: 104,description: 'Old End Date', proposed: '2323223', current: 'child'},
              { RelativeID: 105, description: 'Modified Start Date', proposed: 'New York', current: 'child'},
              { RelativeID: 105, description: 'Modified End Date', proposed: 'Vacation', current: 'child'},
              { RelativeID: 105, description: 'Ticket Number', proposed: '18/12/2018', current: 'child'},
