...
$(document).ready(function () {
    ...
    var replies = "Our Agent will help you soon,Hello I am Mohammad How can i help you,OK can you wait a second please i will try to check the issue for you ";
    ...
    function getReply() {
        ...
        var source = replies.toLowerCase();
        source = source.split(",");
