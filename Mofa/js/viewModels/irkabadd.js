    ...
    function AboutViewModel() {
      ...
      self.connected = function() {
        // Implement if needed
          ...
          self.previewArray = [
              { RelativeID: 101 , description: 'Irkab Type', proposed: 'Mission', current: 'Spouse'},
              { RelativeID: 102, description: 'Decision Type', proposed: 'Irkab Decision', current: 'child'},
              { RelativeID: 103,description: 'Mission/Leave/Training Details/..', proposed: 'visiting New York council', current: 'child'},
              { RelativeID: 104,description: 'Decision Number', proposed: '2323223', current: 'child'},
              { RelativeID: 105, description: 'Destination', proposed: 'New York', current: 'child'},
              { RelativeID: 105, description: 'Ticket Type', proposed: 'Vacation', current: 'child'},
              { RelativeID: 105, description: 'Travel Date', proposed: '18/12/2018', current: 'child'},
              { RelativeID: 105, description: 'Return Date', proposed: '19/12/2020', current: 'child'},
              { RelativeID: 105, description: 'Ticket Class', proposed: 'Business Class', current: 'child'},
          ];
          ...
          self.showStatusMsgs = function(){
              var messages = jQuery('#statusMsg');
              jQuery('.loading').show();
              setTimeout(function(){
                  jQuery('.loading').fadeOut();
                  jQuery('.content').animate({scrollTop:0});
                  messages.show();
