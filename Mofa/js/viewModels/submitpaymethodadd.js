    ...
    function AboutViewModel() {
      ...
      self.connected = function() {
        // Implement if needed
          ...
          self.previewArray = [
              { RelativeID: 101 , description: 'Effective Date', proposed: '12-12-1440', current: 'Spouse'},
              { RelativeID: 102, description: 'Bank Name', proposed: 'Sabb Bank', current: 'child'},
              { RelativeID: 103,description: 'Account Number', proposed: '322332223', current: 'child'},
              { RelativeID: 104,description: 'Action', proposed: 'Approved', current: 'child'},
