    ...
    function(oj, ko, $, ArrayDataProvider) {
        ...
        function DashboardViewModel() {
            ...
            self.connected = function() {
                ...
                self.addchildeducation = function(event){
                   oj.Router.rootInstance.go('childeducationadd');
                }

                self.updatechildeducation = function(event){
                    oj.Router.rootInstance.go('childeducationupdate');
                 }
